 ...
 */
package org.ValidarDatos.src.ValidarDatos;

import java.util.Scanner;

/**
 * @author Antonio Esp�nola Ram�rez
 */
...
//    public static char leerChar(String mensaje, char palabra) {
//        Scanner teclado = new Scanner(System.in);
//        while (!teclado.next().charAt(0)) {
//            System.out.println("Error. No has introducido una cadena de caracteres: ");
//            teclado.next().charAt(0);
//        }
//        palabra = teclado.next().charAt(0);
//        return palabra;
//    }
}
