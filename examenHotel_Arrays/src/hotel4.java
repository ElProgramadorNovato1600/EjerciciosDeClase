...
public class hotel4 {
    ...
    /*Haz una función que muestre las habitaciones que están ocupadas y el cliente
      que la ocupa.*/
...
//        habitaciones[3][1] = true;
//        habitaciones[2][2] = true;
//        habitaciones[1][3] = true;
        ...
        //El usuario elegira una de las habitaciones libres de la planta elegida anteriormente
        ...
        //Muestro las habitaciones ocupadas con el nombre del cliente
        mostrarHabitacionesOcupadas(habitaciones, clientes);
    }
    ...
    /**
     * Muestra las habitaciones ocupadas y libres
     *
     * @param habitaciones Array de las habitaciones
     */
    public static void mostrarHabitaciones(boolean[][] habitaciones) {
        //Determina las habitaciones y plantas
        int habitacion;
        int planta = 1;
        ...
        for (int i = 0; i < habitaciones.length; i++) {
            ...
            for (int j = 0; j < habitaciones.length; j++) {
                if (habitaciones[i][j]) {
                    System.out.println("Habitacion " + habitacion + " ocupada");
                } else {
                    System.out.println("Habitacion " + habitacion + " libre");
                }
                habitacion++;
            }
        }
    ...
    /**
     * Muestra las habitaciones ocupadas con el nombre del cliente que la ocupa
     *
     * @param habitaciones Array de las habitaciones
     * @param clientes     Array de los clientes
     */
    public static void mostrarHabitacionesOcupadas(boolean[][] habitaciones, String[][] clientes) {
        //Determina la planta, la posicion 0 es la planta 4
        int planta = 4;
        for (int i = 0; i < habitaciones.length; i++) {
            for (int j = 0; j < habitaciones.length; j++) {
                if (habitaciones[i][j]) {
