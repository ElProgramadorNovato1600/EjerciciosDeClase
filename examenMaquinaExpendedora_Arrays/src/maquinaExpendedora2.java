...
public class maquinaExpendedora2 {
    ...
    /*Modificar el programa anterior para que se pueda rellenar la máquina y se guarde el nombre del producto
    en la posición indicada. Para ello se irá recorriendo por filas y si falta el producto en ese sitio pedir el
    nombre el producto y se almacenará en la/s variable/s correspondientes.*/
